...
export default function DraftSample() {
  return (
    <div className="draft-block" role="region" aria-label="Sample EHCP Section B draft">
      <div className="draft-block__example">
        <span className="draft-block__example-tag">EXAMPLE</span>
        <span className="draft-block__example-text">Real SENCO output, generated by SENSay from 19 evidence observations</span>
      </div>
